...
static const char DOWNLOAD_ROOT_CERTS[] = 
	//////////////////////////////////////
	...
	// Organizational Name: DigiCert Inc
	// From Date: 2006-11-10 09:00:00
	// To Date: 2031-11-10 09:00:00
	"-----BEGIN CERTIFICATE-----\n"
...
static int HtmlFirmwareUpdate2PostHandler(httpd_request_t* req)
{
	...
	do
	{
		...
		int dlPackageSize = OTADownloadFirmware(packageURI, &dlPackageCRC, DOWNLOAD_ROOT_CERTS);
